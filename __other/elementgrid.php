...
if (!class_exists('MoodleQuickForm_elementgrid')) {
    ...
    if (file_exists($CFG->libdir.'/pear/HTML/QuickForm/elementgrid.php')) {
        ...
        require_once($CFG->dirroot."/local/coursetemplates/__other/HTML/QuickForm/elementgrid.php");
    }
 ...
 */
    class MoodleQuickForm_elementgrid extends HTML_QuickForm_elementgrid {
         ...
         * @return      string
         */
        function setWidths(array $widths) {
        ...
        function toHtml() {
            ...
            if (!is_null($this->_colwidths)) {
                $table->size = $this->_colwidths;
            }
    ...
    MoodleQuickForm::registerElementType('elementgrid', $CFG->dirroot.'/local/coursetemplates/__other/elementgrid.php', 'MoodleQuickForm_elementgrid');
}